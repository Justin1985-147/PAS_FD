...
if ~((nargin==2) && isstruct(varargin{2}))
 ...
 data.LabelYM    = 'yyyymmdd';      %   ... for years and months.
 data.LabelYMD   = 'yyyymmdd';   %   ... for years, months and days.
 ...
 data.NumFmt{3}  = 'yyyymmdd';  
 data.NumFmt{6}  = 'yyyymmdd';        %   Note: {32} is format 0. 
 data.NumFmt{17} = 'yyyymm';
 data.Reference  = 'middle';        % Sets date label reference.
 data.TicksFmt   = [];              % Sets date ticks format.
 data.WhichAxes  = 'n';           % Sets where to write the ticks.
